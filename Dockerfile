...
RUN curl -SL http://artifactory.broadinstitute.org/artifactory/simple/libs-release-local/vault-zips/linux_amd64.zip | funzip > /usr/sbin/vault && chmod +x /usr/sbin/vault
